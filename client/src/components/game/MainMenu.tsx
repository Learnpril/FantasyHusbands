  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-sm mx-4">
        ...
        <div className="relative bg-gradient-to-b from-indigo-900/80 to-purple-900/80 backdrop-blur-sm rounded-lg border-2 border-purple-300/30 shadow-2xl p-2">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="group relative w-full py-2 px-3 text-white font-semibold text-sm tracking-wide transition-all duration-300 hover:scale-105 ui-text"
            >
            ...
            {saves.length > 0 && (
              <button
                ...
                onMouseEnter={() => playButtonHover()}
                className="group relative w-full py-2 px-3 text-white font-semibold text-sm tracking-wide transition-all duration-300 hover:scale-105"
              >
