...
export const useAudio = create<AudioState>((set, get) => ({
  ...
  // Voice acting removed - will be replaced with audio files later
  playCharacterVoice: (characterId: string, text: string) => {
    console.log(`🎤 Voice acting disabled - character ${characterId} would say: "${text}"`);
    // Future: Load and play pre-recorded audio files for each character
  },
